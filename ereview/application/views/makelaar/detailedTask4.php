      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <h6>Waiting-for-payment's Confirmation Task</h6>
            <h2>Here are the list of<span> waiting-for-payment's confirmation task </span>at the<em> moment</em></h2>
          </div>
        </div>
      </div>
    </div>
