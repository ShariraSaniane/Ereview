        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#user">User List</a></li>
              <li class="scroll-to-section"><a href="#tasks">Task List</a></li>
              <li class="scroll-to-section"><a href="#reviewed">Reviewed Paper</a></li>
